...
void wavelet2D::forwardTransformV(const std::shared_ptr<float2DReg> in,
                                  std::shared_ptr<float2DReg> out) {}
void wavelet2D::forwardTransformVP(const std::shared_ptr<float2DReg> in,
                                   std::shared_ptr<float2DReg> out) {}
...
void wavelet2D::inverseTransformV(const std::shared_ptr<float2DReg> in,
                                  std::shared_ptr<float2DReg> out) {}
void wavelet2D::inverseTransformVP(const std::shared_ptr<float2DReg> in,
                                   std::shared_ptr<float2DReg> out) {}
